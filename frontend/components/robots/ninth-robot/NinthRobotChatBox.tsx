...
interface NinthRobotChatBoxProps {
  messages: Message[]
  inputValue: string
...
export default function NinthRobotChatBox({
  messages,
  inputValue,
  setInputValue,
  sendMessage,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: "#E82423" }}
      >
        <h3 className="font-semibold text-lg">Lipo Iron SidrexGPT</h3>
          ...
          {messages.map((message) => (
            <div key={message.id} className={`flex ${message.isUser ? "justify-end" : "justify-start"}`}>
              <div
                ...
                style={message.isUser ? { backgroundColor: "#E82423" } : {}}
              >
      ...
      <div className="p-5 border-t border-gray-200 bg-white rounded-b-lg">
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            style={{ backgroundColor: "#3E3C5E", color: "white" }}
          >
            <Send size={18} />
          </button>
        </div>
