...
interface TenthRobotChatBoxProps {
  messages: Message[]
  inputValue: string
...
export default function TenthRobotChatBox({
  messages,
  inputValue,
  setInputValue,
  sendMessage,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: "#88ED92" }}
      >
        <h3 className="font-semibold text-lg">Pro Men SidrexGPT</h3>
          ...
          {messages.map((message) => (
            <div key={message.id} className={`flex ${message.isUser ? "justify-end" : "justify-start"}`}>
              <div
                ...
                style={message.isUser ? { backgroundColor: "#88ED92" } : {}}
              >
      ...
      <div className="p-5 border-t border-gray-200 bg-white rounded-b-lg">
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            style={{ backgroundColor: "#005176", color: "white" }}
          >
            <Send size={18} />
          </button>
        </div>
