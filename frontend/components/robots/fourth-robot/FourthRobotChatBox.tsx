...
interface FourthRobotChatBoxProps {
  messages: Message[]
  inputValue: string
...
export default function FourthRobotChatBox({
  messages,
  inputValue,
  setInputValue,
  sendMessage,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "#5CA9ED" }}
      >
        <h3 className="font-semibold text-lg">Zzen Asistanı</h3>
          ...
          {messages.map((message) => (
            <div key={message.id} className={`flex ${message.isUser ? "justify-end" : "justify-start"}`}>
              <div
                ...
                style={message.isUser ? { backgroundColor: "#5CA9ED" } : {}}
              >
      ...
      <div className="p-5 border-t border-gray-200 bg-white rounded-b-lg">
        <div className="flex items-center space-x-3">
          <input
            ...
            placeholder="Uyku sorunlarınızı yazın..."
