...
interface EleventhRobotChatBoxProps {
  messages: Message[]
  inputValue: string
...
export default function EleventhRobotChatBox({
  messages,
  inputValue,
  setInputValue,
  sendMessage,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "#FF8616" }}
      >
        <h3 className="font-semibold text-lg">Imuntus SidrexGPT</h3>
          ...
          {messages.map((message) => (
            <div key={message.id} className={`flex ${message.isUser ? "justify-end" : "justify-start"}`}>
              <div
                ...
                style={message.isUser ? { backgroundColor: "#FF8616" } : {}}
              >
      ...
      <div className="p-5 border-t border-gray-200 bg-white rounded-b-lg">
        <div className="flex items-center space-x-3">
          <input
            ...
            className="flex-1 px-4 py-3 border rounded-full text-sm focus:outline-none focus:ring-2 focus:border-transparent"
            style={{ borderColor: "#572761", "--tw-ring-color": "#572761" } as React.CSSProperties}
            disabled={isLoading}
          />
          <button
            onClick={sendMessage}
